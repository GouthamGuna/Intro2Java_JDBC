...
public class DemoPDFStyle {
    ...
    public static void addMetaData(Document document) {
        document.addTitle( "CERP Software Solutions Pvt.Ltd." );
        document.addSubject( "PDF MAKER" );
        document.addKeywords( "Java, PDF, iText" );
        document.addAuthor( "Gowtham Sankar Gunasekaran" );
        document.addCreator( "Gowtham Sankar Gunasekaran" );
    }
    ...
    public static void addTitlePage(Document document) throws DocumentException {
        ...
        preface.add( new Paragraph( "This document is a preliminary version and not subject to your license agreement or any other agreement with google.com ;-).", redFont ) );
